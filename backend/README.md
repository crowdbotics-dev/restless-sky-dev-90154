...
## Project Structure
    ...
    ├── restless_sky_dev_90154  # Django project configurations
...
1. Clone this repo and `cd restless_sky_dev_90154`
...
2. Clone this repo and `cd restless_sky_dev_90154`
