"""
Django settings for restless_sky_dev_90154 project.
...
ROOT_URLCONF = 'restless_sky_dev_90154.urls'
...
WSGI_APPLICATION = 'restless_sky_dev_90154.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_sky_dev_90154 API",
    "DESCRIPTION": "API documentation for restless_sky_dev_90154 App",
    "VERSION": "v1",
}
